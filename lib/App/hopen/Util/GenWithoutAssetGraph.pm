...
use Data::Hopen qw(:default :log getparameters *QUIET *VERBOSE);
...
sub _finalize {
    ...
    hlog { Finalizing => ref($self), '- phase', $args{phase}->name };
