...
L<App::hopen::Asset> instances.  These instances represent files or other
...
During the Gen phase, the generator receives information from each
command node about work to transform that node's C<made> inputs into
outputs.
