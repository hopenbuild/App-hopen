# Build::Hopen::Scope::Overrides - Scope that can override each set individually
package Build::Hopen::Scope::Overrides;
use Build::Hopen;
...
L<Build::Hopen::Scope::Hash> as an override.  However, that only holds
